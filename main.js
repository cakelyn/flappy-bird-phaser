...
var mainState = {
  ...
  create: function() {
    ...
    // Group to contain all of our empty pipes
    ...
    // Call the 'jump' function when we ta/click on the screen
  ...
  update: function() {
    ...
    // Rotate bird downward, up to a certain point
  ...
  jump: function() {
    ...
    this.bird.ancor.setTo(-0.2, 0.5);
    
    // Bird cannot jump when dead
    if (this.bird.alive == false)
      return;
    
    // Play sound effect on jump
    this.jumpSound.play();
  },
  ...
  addOnePipe: function(x, y) {
    ...
    // Automatically kill the pipe when it's no longer visable
